...
DEPARTMENT_SEEDS: dict[str, tuple[str, ...]] = {
    ...
    "Higiene": (
        "Sabonete", "Sabonete Líquido", "Shampoo", "Condicionador",
        "Máscara Capilar", "Creme de Pentear", "Óleo Capilar", "Tintura de Cabelo",
        "Desodorante", "Antitranspirante", "Colônia", "Perfume", "Protetor Solar",
        "Creme Hidratante", "Creme Facial", "Sérum Facial", "Demaquilante",
        "Água Micelar", "Algodão", "Creme Dental", "Pasta Dental", "Escova Dental",
        "Fio Dental", "Enxaguante Bucal", "Aparelho de Barbear", "Lâmina de Barbear",
        "Creme de Barbear", "Pós-Barba", "Absorvente", "Protetor Diário",
        "Papel Higiênico", "Lenço de Papel", "Toalha Umedecida", "Fralda Descartável",
        "Fralda Geriátrica", "Cotonete", "Creme para Assadura", "Talco",
        "Shampoo Infantil", "Sabonete Infantil", "Kit Presente", "Haste Flexível",
        "Removedor de Esmalte", "Esmalte", "Batom", "Base Facial",
    ),
    "Limpeza": (
        "Detergente Líquido", "Detergente em Pó", "Sabão em Pó", "Sabão em Barra",
        "Amaciante", "Lava-Roupas", "Tira-Manchas", "Água Sanitária",
        "Desinfetante", "Limpador Multiuso", "Limpador de Vidros", "Limpador Pesado",
        "Limpa Forno", "Lustra-Móveis", "Inseticida", "Repelente", "Esponja de Limpeza",
        "Pano de Limpeza", "Flanela", "Saco de Lixo", "Pasta para Esfregar",
        "Limpador de Piso", "Cera para Piso", "Desengordurante", "Aromatizante",
        "Odorizador de Ambientes", "Saponáceo", "Álcool Líquido", "Álcool em Gel",
        "Vassoura", "Rodo", "Pá de Lixo", "Balde", "Luva de Limpeza", "Sabão Líquido",
        "Limpa-Alumínio", "Tira-Gordura", "Refil de Limpeza",
    ),
    "Bazar e Utilidades": (
        "Papel Toalha", "Papel Alumínio", "Papel Filme", "Papel Manteiga",
        "Saco Plástico", "Saco para Congelados", "Descartáveis de Festa",
        "Copo Descartável", "Prato Descartável", "Talher Descartável", "Guardanapo",
        "Toalha de Papel", "Esponja de Aço", "Pilha", "Bateria", "Lâmpada",
        "Fósforo", "Isqueiro", "Vela", "Lixeira", "Cesto de Lixo", "Cabide",
        "Organizador", "Gancho", "Corda", "Fita Adesiva", "Cola", "Tesoura",
        "Caderno", "Caneta", "Lápis", "Borracha", "Papel Sulfite", "Envelope",
        "Brinquedo", "Jogo de Tabuleiro", "Material Escolar", "Utensílio de Cozinha",
        "Panela", "Frigideira", "Forma", "Assadeira", "Jogo Americano", "Toalha de Mesa",
        "Pano de Prato", "Avental", "Luva de Silicone", "Garrafa Térmica",
        "Marmita", "Pote Plástico", "Coador", "Filtro de Café", "Vestuário",
        "Meias", "Cueca", "Sunga", "Chinelo", "Touca de Banho", "Automotivo",
        "Acessório para Carro", "Flores e Plantas", "Vaso", "Terra para Plantas",
        "Ração para Jardim", "Eletroportátil", "Ferramenta",
    ),
    "Doces e Sobremesas": (
        "Chocolate", "Chocolate ao Leite", "Chocolate Amargo", "Chocolate Branco",
        "Barra de Chocolate", "Bombom", "Trufa", "Ovo de Páscoa", "Balas",
        "Chiclete", "Pirulito", "Goma", "Marshmallow", "Paçoca", "Doce de Leite",
        "Goiabada", "Marmelada", "Geleia de Frutas", "Cocada", "Pé de Moleque",
        "Rapadura", "Doce de Abóbora", "Creme de Avelã", "Chocolate em Pó",
        "Cobertura de Chocolate", "Granulado", "Gelatina", "Pudim", "Flan",
        "Sobremesa Pronta", "Mousse", "Manjar", "Arroz Doce", "Doce em Calda",
        "Frutas em Calda", "Suspiro", "Brigadeiro", "Beijinho", "Churros",
        "Bala de Goma", "Cocada Cremosa", "Doce de Banana",
    ),
    "Padaria": (
        "Pão Francês", "Pão de Forma", "Pão Integral", "Pão de Leite",
        "Bisnaguinha", "Pão de Hamburguer", "Pão de Hot Dog", "Pão Sírio",
        "Pão Australiano", "Pão de Queijo", "Pão Doce", "Brioche", "Croissant",
        "Baguete", "Ciabatta", "Broa", "Roscas", "Sonho", "Bolo Pronto",
        "Bolo de Cenoura", "Bolo de Chocolate", "Bolo de Fubá", "Torta Doce",
        "Panetone", "Chocotone", "Torrada", "Torrada Integral", "Biscoito Cream Cracker",
        "Rapadurinha", "Pão de Centeio", "Pão Sem Glúten", "Massa Folhada Pronta",
        "Pão de Alho", "Pão Caseiro", "Cuca", "Bolo de Pacote",
    ),
    "Hortifruti": (
        "Banana", "Banana Prata", "Maçã", "Laranja", "Pera", "Uva", "Manga",
        "Abacaxi", "Melancia", "Melão", "Mamão", "Goiaba", "Morango", "Limão",
        "Tangerina", "Mexerica", "Pêssego", "Ameixa", "Kiwi", "Coco", "Maracujá",
        "Tomate", "Cebola", "Alho", "Batata", "Batata Doce", "Cenoura", "Abobrinha",
        "Chuchu", "Beterraba", "Pimentão", "Pepino", "Alface", "Couve", "Espinafre",
        "Brócolis", "Repolho", "Rúcula", "Cheiro Verde", "Salsa", "Cebolinha",
        "Coentro", "Mandioca", "Inhame", "Cará", "Milho Verde", "Vagem", "Berinjela",
        "Abóbora", "Mandioca", "Gengibre", "Batata Baroa", "Aipim", "Tomate Italiano",
        "Ervilha Fresca", "Ovo de Granja",
    ),
    "Congelados": (
        "Pizza Congelada", "Pizza de Calabresa", "Lasanha Congelada",
        "Nuggets de Frango", "Hambúrguer Congelado", "Sorvete", "Picolé",
        "Sobremesa Gelada", "Frango Congelado", "Carne Congelada", "Peixe Congelado",
        "Camarão Congelado", "Polpa de Fruta Congelada", "Vegetais Congelados",
        "Batata Frita Congelada", "Batata Pré-Frita", "Mistura para Yakissoba Congelada",
        "Prato Pronto Congelado", "Empanado de Frango", "Kibe Congelado",
        "Coxinha Congelada", "Pastel Congelado", "Pão de Queijo Congelado",
        "Torta Congelada", "Torta Salgada Congelada", "Esfiha Congelada",
        "Salgadinho Congelado", "Massa de Pastel", "Frango a Passarinho Congelado",
        "Açaí", "Açaí na Tigela", "Sobremesa Congelada", "Legumes Congelados",
        "Espinafre Congelado", "Ervilha Congelada", "Milho Congelado", "Batata Palha Congelada",
        "Picanha Congelada", "Costela Congelada",
    ),
    "Pet Shop": (
        "Ração para Cães", "Ração para Gatos", "Ração Filhote", "Ração Sênior",
        "Ração Premium", "Petisco para Cães", "Petisco para Gatos", "Biscoito para Pets",
        "Osso Pet", "Brinquedo para Pets", "Areia para Gatos", "Areia Sanitária",
        "Shampoo para Pets", "Anti-pulgas", "Vermífugo Pet", "Coleira",
        "Guia para Pets", "Comedouro", "Bebedouro", "Cama para Pets", "Tapete Higiênico",
        "Suplemento Pet", "Alimento Úmido para Gatos", "Sachê para Gatos",
        "Patê para Pets", "Ração Úmida", "Snack Dental Pet", "Higiene Pet",
    ),
    "Saudáveis e Orgânicos": (
        "Granola", "Barra de Cereal", "Barra de Proteína", "Mix de Castanhas",
        "Castanha-do-Pará", "Castanha de Caju", "Nozes", "Amêndoas", "Aveia em Flocos",
        "Farinha Integral", "Farinha de Amêndoas", "Farinha de Coco", "Quinoa",
        "Semente de Chia", "Semente de Linhaça", "Semente de Girassol", "Proteína Vegetal",
        "Proteína de Soja", "Leite Vegetal", "Bebida Vegetal", "Iogurte Vegetal",
        "Pasta de Amendoim", "Pasta de Gergelim", "Mel", "Açúcar de Coco",
        "Cacau em Pó", "Café Orgânico", "Produto Orgânico", "Produto Sem Glúten",
        "Produto Sem Lactose", "Produto Vegano", "Alimento Funcional",
        "Óleo de Coco", "Óleo de Linhaça", "Suplemento Alimentar", "Chá Funcional",
        "Farinha de Banana Verde", "Colágeno", "Whey Protein", "Alimento Fit",
        "Snack Saudável", "Vegetais Orgânicos", "Frutas Secas",
    ),
    "Peixaria": (
        "Filé de Tilápia", "Filé de Merluza", "Filé de Pescada", "Salmão",
        "Sardinha", "Atum", "Bacalhau", "Camarão", "Lula", "Polvo", "Mexilhão",
        "Ostra", "Marisco", "Pescado Inteiro", "Peixe Inteiro", "Filé de Peixe",
        "Anchova", "Corvina", "Dourado", "Lambari", "Pintado", "Tambaqui",
        "Pirarucu", "Bagre", "Tainha", "Cação", "Peixe Salgado", "Cavalinha",
        "Pescada Branca", "Filé de São Pedro", "Peixe Congelado", "Isca de Peixe",
        "Camarão Descascado", "Camarão Empanado", "Frutos do Mar", "Espeto de Camarão",
        "Tilápia Inteira", "Salmão Defumado",
    ),
}
